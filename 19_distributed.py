...
# create a master.conf file
# create a worker.conf file
# execute test file with locust --config ./resources/master.conf on master machine
# execute test file with locust --config ./resources/worker.conf on worker machines
